...
class edge {
    ...
    handleCommPort(args) {
        ...
        self.serialPort.open(function (error) {
            if (error) {
                console.log('open commPort Error but ignoring it: ' + error);
            }

            console.log('commPort open');
            ...
            let tmrRx = function () {
                ...
                if (locbuf.length > 0) {
                    console.log('modbus Response', locbuf)
    ...
    compileOutputs(args) {
        ...
        for (let i = 0; i < self.commands.length; i++) {
            ...
            self.commands[i].output[4] = (1 / 256) & 255   //Register Length
            self.commands[i].output[5] = 1 & 255           //Register Length
